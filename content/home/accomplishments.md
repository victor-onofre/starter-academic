...
- certificate_url: https://www.coursera.org/account/accomplishments/specialization/certificate/WANKVTDUMF2G
  ...
  description: In 9 courses, I applied Data Science methodology - Worked with Jupyter notebooks - Accessed relational databases using SQL and Python - Used Python              |2- libraries to generate data visualizations -Performed data analysis using Pandas - Constructed and evaluated Machine Learning (ML) models using Scikit-learn and |3- SciPy and applied data science and ML techniques to real location data sets.
